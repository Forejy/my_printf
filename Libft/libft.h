...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/08 18:07:30 by jmarques          #+#    #+#             */
/*   Updated: 2018/04/10 18:20:51 by jmarques         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_charac_is_base(char c, const char *base);
...
t_list_			*ft_list_find(t_list_
				*begin_list, void *data_ref, int (*cmp)());
void			ft_list_push_front(t_list_
				**begin_list, void *data);
